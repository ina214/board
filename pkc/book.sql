...
INSERT INTO `adminmember` VALUES (4,'마스터','admin','1234',100),(5,'슈퍼맨','superman','1234',50),(6,'배트맨','batman','1234',50);
...
INSERT INTO `baesong` VALUES (1,'harang','11700','경기 의정부시 평화로 443','1104','010-1234-5678',0,1,'변지훈'),(2,'harang','13529','경기 성남시 분당구 백현동 532','1층','010-111-1111',0,0,'ㅇㄴ');
...
INSERT INTO `cart` VALUES (6,'admin','A101004',1,'2025-08-21 17:15:45'),(9,'harang','A101001',5,'2025-08-22 12:04:56'),(10,'harang','B102035',1,'2025-08-22 13:05:28'),(11,'harang','A101003',1,'2025-10-14 10:59:27');
...
INSERT INTO `coupon` VALUES (4,'A1',15,NULL,7,'20251010002','2025-10-14',NULL),(5,'B1',99,'2025-10-20',0,'20251010003','2025-10-14',NULL),(6,'C1',15,'2025-10-20',0,'20251010004','2025-10-14',NULL),(7,'D1',99,NULL,9,'20251010005','2025-10-14',NULL);
...
INSERT INTO `gumae` VALUES (1,'harang',1,'A101001',1,2,0,0,0,0,0,14365,5,'j20250820001',1,'2025-08-20 16:18:24'),(2,'harang',1,'A101001',5,2,0,0,0,0,0,538625,0,'j20250822001',0,'2025-08-22 13:05:38'),(3,'harang',1,'B102035',1,2,0,0,0,0,0,538625,1,'j20250822001',0,'2025-08-22 13:05:38'),(4,'harang',1,'B102038',1,0,0,0,0,0,0,65800,0,'j20251016001',0,'2025-10-16 11:58:04');
...
INSERT INTO `jumun` VALUES (1,'A101001',100,0,0,0,'admin',NULL,'2025-10-16',NULL),(2,'A101038',100,1,20,80,'admin','admin','2025-10-16','2025-10-17'),(3,'A101044',99,0,0,0,'admin',NULL,'2025-10-16',NULL),(4,'A101045',81,0,0,0,'admin',NULL,'2025-10-16',NULL),(5,'A101050',36,0,0,0,'admin',NULL,'2025-10-16',NULL),(6,'A101050',82,0,0,0,'admin',NULL,'2025-10-16',NULL);
/*!40000 ALTER TABLE `jumun` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lecapply`
--

DROP TABLE IF EXISTS `lecapply`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lecapply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` char(20) DEFAULT NULL,
  ...
  `writeday` date DEFAULT NULL,
  `jcode` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lecapply`
--

LOCK TABLES `lecapply` WRITE;
/*!40000 ALTER TABLE `lecapply` DISABLE KEYS */;
INSERT INTO `lecapply` VALUES (3,'channy',1,1,'2025-10-22','2025-10-14',1760427225401),(4,'channy',1,1,'2025-10-29','2025-10-14',1760427632821),(5,'channy',1,2,'2025-10-31','2025-10-14',1760427638972),(6,'channy',1,2,'2025-10-29','2025-10-14',1760428570284),(7,'channy',1,1,'2025-10-21','2025-10-14',1760430115537),(8,'channy',1,2,'2025-10-30','2025-10-14',1760430122363),(9,'channy',2,1,'2025-10-31','2025-10-15',1760487970630),(10,'channy',1,1,'2025-10-22','2025-10-15',1760493192898),(11,'channy',1,1,'2025-10-22','2025-10-15',1760493277040),(13,'channy',1,2,'2025-10-22','2025-10-15',1760493651185),(14,'channy',1,2,'2025-10-22','2025-10-15',1760493654430),(15,'channy',1,2,'2025-10-22','2025-10-15',1760493657806),(16,'channy',1,1,'2025-11-13','2025-10-15',1760493668088),(17,'channy',1,1,'2025-11-13','2025-10-15',1760493673240),(18,'channy',1,1,'2025-11-13','2025-10-15',1760493676238),(19,'channy',2,1,'2025-10-25','2025-10-15',1760493753605),(20,'channy',2,1,'2025-10-25','2025-10-15',1760493756822),(21,'channy',2,1,'2025-10-25','2025-10-15',1760493759286),(22,'channy',2,1,'2025-10-25','2025-10-15',1760493761526),(23,'channy',2,1,'2025-10-25','2025-10-15',1760493763680),(24,'channy',2,1,'2025-10-25','2025-10-15',1760493765942),(25,'channy',2,1,'2025-10-25','2025-10-15',1760493768317),(26,'channy',2,1,'2025-10-25','2025-10-15',1760493771084),(27,'channy',2,1,'2025-10-25','2025-10-15',1760493773620),(28,'channy',2,1,'2025-10-25','2025-10-15',1760493776030),(29,'channy',2,1,'2025-10-31','2025-10-15',1760495172027),(30,'channy',1,1,'2025-10-29','2025-10-15',1760495187008),(31,'channy',1,1,'2025-10-29','2025-10-15',1760495190311),(32,'channy',7,1,'2025-10-28','2025-10-15',1760496125546),(33,'channy',7,1,'2025-10-28','2025-10-15',1760496154024),(34,'channy',8,1,'2025-11-04','2025-10-15',1760496729449);
/*!40000 ALTER TABLE `lecapply` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `leclist`
--

DROP TABLE IF EXISTS `leclist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `leclist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` char(20) DEFAULT NULL,
...
--
-- Dumping data for table `leclist`
--

LOCK TABLES `leclist` WRITE;
/*!40000 ALTER TABLE `leclist` DISABLE KEYS */;
INSERT INTO `leclist` VALUES (1,'홍길동','역사는 흐른다','2025-10-20','2025-11-30',2,'2025-10-14 15:07:43',3),(2,'뽀로로','카봇중에 누가 제일 강할까?','2025-10-25','2025-12-15',2,'2025-10-15 09:23:19',10),(8,'슈퍼맨','열심히 하늘을 날아가는 방법은?','2025-10-28','2025-11-10',4,'2025-10-15 11:51:59',10),(9,'아무개','강의1','2025-10-16','2025-11-01',2,'2025-10-15 12:04:33',5);
/*!40000 ALTER TABLE `leclist` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `lecture` (
  ...
  `sday` datetime DEFAULT NULL,
  `eday` datetime DEFAULT NULL,
  `max` int(11) DEFAULT NULL,
  `price01` int(11) DEFAULT NULL,
  `price02` int(11) DEFAULT NULL,
...
INSERT INTO `lecture` VALUES (1,'천재들의 시간관리 루틴, 그리고 시간관리의 마지막 비법 \'리버럴 아츠\'','images.png','2025-09-17 00:00:00','2025-09-25 00:00:00',NULL,NULL,NULL,''),(2,'천재들의 시간관리 루틴, 그리고 시간관리의 마지막 비법 \'리버럴 아츠\'111','images.png','2025-09-11 00:00:00','2025-10-02 00:00:00',NULL,NULL,NULL,''),(3,'당신은 잘 자고 있나요? 불면증 치료하고 잠을 잘 자는 방법!','images1.jpg','2025-09-22 00:00:00','2025-10-10 00:00:00',20,10000,8000,'2회차'),(5,'나는 이제 싫다고 말하기로 했다! 나와 관계를 지키는 거절하는 법','images.jpg','2025-09-15 00:00:00','2025-10-10 00:00:00',4,100,200,'4회차'),(6,'즐거운 화요일','삼성_대형TV.jpg','2025-10-15 00:00:00','2025-10-29 00:00:00',30,10000,5000,'2회차'),(7,'즐거운 10월','삼성_대형TV.jpg','2025-10-16 00:00:00','2025-10-31 00:00:00',30,1000,500,'2회차');
/*!40000 ALTER TABLE `lecture` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lecturereserve`
--

DROP TABLE IF EXISTS `lecturereserve`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lecturereserve` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `saveday` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
-- Dumping data for table `lecturereserve`
--

LOCK TABLES `lecturereserve` WRITE;
/*!40000 ALTER TABLE `lecturereserve` DISABLE KEYS */;
INSERT INTO `lecturereserve` VALUES (10,'2025-10-15',',1',1,1,0,'2025-10-13 15:00:00','c300ef93-abbe-45c5-89e1-327be5b795dc','harang',NULL);
/*!40000 ALTER TABLE `lecturereserve` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-10-17 17:42:18
